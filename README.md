...
![Dashboard Screenshot](full_dashboard.png)
...
- `Superstore_Executive_Dashboard.pbix` — the full Power BI file (open in Power BI Desktop to explore interactively)
- `full_dashboard.png` — full-page view of the dashboard
- `Screenshot *.png` — additional close-up views of individual visuals
